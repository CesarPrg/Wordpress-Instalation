...
Aunque el sistema operativo ya trae preinstalado un interprete de _PHP_ instalaremos la última versión estable de linux en la web oficial https://www.php.net/downloads, debemos acordarnos que debe acabar en *.tar.gz*, descargamos el archivo php-8.1.16.tar.gz y lo descomprimimos para poder instalarlo:

image::assets/imgs/descargasPHP.png[info_php, 600,600]
```
